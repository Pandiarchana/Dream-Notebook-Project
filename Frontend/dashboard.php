...
<aside class="sidebar">
  ...
  <nav class="menu">
    ...
    <a href="write_entry.html">✍️ Write Entry</a>
...
<main class="main">
  ...
  <div class="entry-card">
    ...
    <div class="entry-actions">
      <a href="../backend/edit_entry.php?id=<?= $row['id'] ?>" class="btn-sm btn-edit">✏️ Edit</a>
      <form action="../backend/delete_entry.php" method="POST" style="display:inline">
